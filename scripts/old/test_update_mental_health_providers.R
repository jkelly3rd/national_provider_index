...
healthproviders <- read_csv("/Volumes/Jarvis/R/obgyn/npidata_pfile_20050523-20221211.csv", 
                                  col_types = cols(.default = "c"))

taxonomy <- unique(mentalhealthproviders$code1)

mentalhealthproviders_test2 <- healthproviders %>% filter(healthproviders$code1 %in% taxonomy | 
                                                           mentalhealthproviders$code2 %in% taxonomy | 
                                                           mentalhealthproviders$code3 %in% taxonomy | 
                                                           mentalhealthproviders$code4 %in% taxonomy | 
                                                           mentalhealthproviders$code5 %in% taxonomy | 
                                                           mentalhealthproviders$code6 %in% taxonomy | 
                                                           mentalhealthproviders$code7 %in% taxonomy | 
                                                           mentalhealthproviders$code8 %in% taxonomy | 
                                                           mentalhealthproviders$code9 %in% taxonomy | 
                                                           mentalhealthproviders$code10 %in% taxonomy | 
                                                           mentalhealthproviders$code11 %in% taxonomy | 
                                                           mentalhealthproviders$code12 %in% taxonomy | 
                                                           mentalhealthproviders$code13 %in% taxonomy | 
                                                           mentalhealthproviders$code14 %in% taxonomy | 
                                                           mentalhealthproviders$code15 %in% taxonomy)


mentalhealthproviders <- mentalhealthproviders %>% 
  select(1,2,5:13,29:34,48)
